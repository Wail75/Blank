...
my %last_email_args;
{
  ...
  *Blank::Model::Emailer::send_email = sub { (undef, %last_email_args) = @_; return 1 };
}
...
subtest 'Profile management' => sub {
  ...
  $t->get_ok("$profiles/x$id")
    ->status_is(200)
    ->text_like('b#notif-error' => qr/This profile is not available/)
    ->text_like('h1'            => qr//);
